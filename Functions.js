...
//console.log(buildTriangle(10));
 ...
 function makeLine(theLine) {
    let line = "";
    for (let j = 1; j <= theLine; j++) {
      line += "* "
    }
    return line + "\n";
   };
...
function emotions(myString, myFunc) {
 ...
 // Argument 2 - an inline function expression
  console.log(emotions("happy",function laugh(num){
     let theLaugh ="";
